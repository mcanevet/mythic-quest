...
End screens (game-over/win) are a three-part compound trap; each part alone seems fine and ships, then QA discovers the missing third at the worst time. From run 12 (lumo-max, 09-09; bugfix plans 15/17/18 — three separate rework cycles on one end-screen flow):
