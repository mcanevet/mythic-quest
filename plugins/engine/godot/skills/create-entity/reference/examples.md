...
Output:
- `entities/player.tscn` — CharacterBody2D root, CollisionShape2D (RectangleShape2D 20x100), Sprite2D
...
Output:
- `entities/pickup.tscn` — Area2D root, CollisionShape2D (CircleShape2D r=10), Sprite2D
...
Output:
- `entities/projectile.tscn` — RigidBody2D root, CollisionShape2D (CircleShape2D r=10), Sprite2D
